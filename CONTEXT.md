...
_Regenerated 2026-08-11T10:46:28+00:00 by `forecast/score.py`. Do not hand-edit._
...
- Observations: **18**
- Range: `2026-07-24` to `2026-08-10`
- Gaps: **0**
- Forecasts written: **12**
- Forecasts scored: **11**
- Awaiting outcome: **1**

Most recent scored call — `2026-08-10` (`prior` mode): predicted **-0.42c**, actual **-0.30c**, error **+0.12c**.

## What the model is keying on

**Not fitted yet.** The ridge model needs 30 complete training rows and has **10**. Until then every forecast comes from the bootstrap prior, which is a rule of thumb with no coefficients to show.
...
- Effective n, by error correlation: **5.1** (lag-1 r = +0.36)
- Effective n, by price-change correlation: **3.6** (lag-1 r = +0.51)
...
|---|---|---|---|---|
| > -2c | 0.0859 | +0.1641 | 0.91 | 11 |
| > -1c | 0.2375 | +0.0125 | 0.64 | 11 |
| > +0c **(headline)** | 0.2155 | +0.0345 | 0.09 | 11 |
| > +1c | 0.0211 | +0.2289 | 0.00 ⚠︎ degenerate | 11 |
| > +2c | 0.0005 | +0.2495 | 0.00 ⚠︎ degenerate | 11 |
...
- PIT mean: **0.290** (target 0.500)
- 80% interval coverage: **72.7%** (target 80.0%)
- Residual sd 0.86c vs claimed sigma 1.00c (ratio 0.86)
- Spread check: **held** at n_eff = 3.6 (needs 20). Errors currently look close to the claimed sigma, but that comparison is not yet evidence.

**Reliability** (pooled across thresholds; bins with n<3 suppressed)

| bin | n | predicted | observed | gap |
|---|---|---|---|---|
| 0.0–0.1 | 14 | 0.033 | 0.000 | -3.3pp |
| 0.1–0.3 | 8 | 0.159 | 0.000 | -15.9pp |
| 0.3–0.5 | 8 | 0.426 | 0.000 | -42.6pp |
| 0.5–0.7 | 3 | 0.544 | 0.333 | -21.0pp |
| 0.7–0.9 | 11 | 0.809 | 0.636 | -17.3pp |
| 0.9–1.0 | 11 | 0.968 | 0.909 | -5.9pp |
