...
_Regenerated 2026-08-06T15:33:14+00:00 by `forecast/score.py`. Do not hand-edit._
...
- Observations: **8**
- Range: `2026-07-30` to `2026-08-06`
- Gaps: **0**
- Forecasts written: **7**
- Forecasts scored: **7**
- Awaiting outcome: **0**

Most recent scored call — `2026-08-06` (`prior` mode): predicted **-0.10c**, actual **-1.68c**, error **-1.58c**.
...
- Effective n, by error correlation: **7.0** (lag-1 r = -0.01)
- Effective n, by price-change correlation: **5.3** (lag-1 r = +0.13)
...
|---|---|---|---|---|
| > -2c | 0.0005 | +0.2495 | 1.00 ⚠︎ degenerate | 7 |
| > -1c | 0.1150 | +0.1350 | 0.86 | 7 |
| > +0c **(headline)** | 0.2586 | -0.0086 | 0.14 | 7 |
| > +1c | 0.0280 | +0.2220 | 0.00 ⚠︎ degenerate | 7 |
| > +2c | 0.0007 | +0.2493 | 0.00 ⚠︎ degenerate | 7 |
...
- PIT mean: **0.330** (target 0.500)
- 80% interval coverage: **85.7%** (target 80.0%)
- Residual sd 0.75c vs claimed sigma 1.00c (ratio 0.75)
- Spread check: **held** at n_eff = 5.3 (needs 20). Errors currently look close to the claimed sigma, but that comparison is not yet evidence.

**Reliability** (pooled across thresholds; bins with n<3 suppressed)

| bin | n | predicted | observed | gap |
|---|---|---|---|---|
| 0.0–0.1 | 7 | 0.024 | 0.000 | -2.4pp |
| 0.1–0.3 | 7 | 0.164 | 0.000 | -16.4pp |
| 0.3–0.5 | 4 | 0.478 | 0.000 | -47.8pp |
| 0.5–0.7 | 3 | 0.544 | 0.333 | -21.0pp |
| 0.7–0.9 | 7 | 0.844 | 0.857 | +1.3pp |
| 0.9–1.0 | 7 | 0.977 | 1.000 | +2.3pp |
